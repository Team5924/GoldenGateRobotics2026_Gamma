...
import org.team5924.frc2026.Constants.Field;
...
public class FieldConstants {
  ...
  public static final int aprilTagCount = Field.field.getTags().size();
  public static final double aprilTagWidth = Units.inchesToMeters(6.5);

  // Field dimensions
  public static final double fieldLength = Field.field.getFieldLength();
  public static final double fieldWidth = Field.field.getFieldWidth();
  ...
  public static class LinesVertical {
    ...
    public static final double starting = Field.field.getTagPose(26).get().getX();
    public static final double allianceZone = starting;
    public static final double hubCenter =
        Field.field.getTagPose(26).get().getX() + Hub.width / 2.0;
    ...
    public static final double oppHubCenter =
        Field.field.getTagPose(4).get().getX() + Hub.width / 2.0;
    public static final double oppAllianceZone = Field.field.getTagPose(10).get().getX();
  }
  ...
  public static class Hub {
    ...
    public static final Translation3d topCenterPoint =
        new Translation3d(
            Field.field.getTagPose(26).get().getX() + width / 2.0, fieldWidth / 2.0, height);
    public static final Translation3d innerCenterPoint =
        new Translation3d(
            Field.field.getTagPose(26).get().getX() + width / 2.0, fieldWidth / 2.0, innerHeight);
    ...
    public static final Translation3d oppTopCenterPoint =
        new Translation3d(
            Field.field.getTagPose(4).get().getX() + width / 2.0, fieldWidth / 2.0, height);
    ...
    // Hub faces
    public static final Pose2d nearFace = Field.field.getTagPose(26).get().toPose2d();
    public static final Pose2d farFace = Field.field.getTagPose(20).get().toPose2d();
    public static final Pose2d rightFace = Field.field.getTagPose(18).get().toPose2d();
    public static final Pose2d leftFace = Field.field.getTagPose(21).get().toPose2d();
  }
  ...
  public static class Tower {
    ...
    public static final Translation2d centerPoint =
        new Translation2d(frontFaceX, Field.field.getTagPose(31).get().getY());
    public static final Translation2d leftUpright =
        new Translation2d(
            frontFaceX,
            (Field.field.getTagPose(31).get().getY())
                + innerOpeningWidth / 2
    ...
    public static final Translation2d oppCenterPoint =
        new Translation2d(fieldLength - frontFaceX, Field.field.getTagPose(15).get().getY());
    public static final Translation2d oppLeftUpright =
        new Translation2d(
            fieldLength - frontFaceX,
            (Field.field.getTagPose(15).get().getY())
                + innerOpeningWidth / 2
                + Units.inchesToMeters(0.75));
  ...
  public static class Outpost {
    ...
    // Relevant reference points on alliance side
    public static final Translation2d centerPoint =
        new Translation2d(0, Field.field.getTagPose(29).get().getY());
  }
