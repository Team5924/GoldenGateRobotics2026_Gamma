...
public class MatchState {
  private static MatchState instance = new MatchState();
  ...
  public void logData() {
    Logger.recordOutput("MatchState/isHubActive", isHubActive());
    Logger.recordOutput("MatchState/MatchTime", DriverStation.getMatchTime());
    Logger.recordOutput("MatchState/MatchShift", currentMatchShift.toString());
    Logger.recordOutput("MatchState/isAutoWinner", isAutoWinner);
    Logger.recordOutput("MatchState/hasAutoWinner", hasAutoWinner);
    Logger.recordOutput("MatchState/isBlue", isBlue);
    Logger.recordOutput("MatchState/hasAlliance", hasAlliance);
  }
