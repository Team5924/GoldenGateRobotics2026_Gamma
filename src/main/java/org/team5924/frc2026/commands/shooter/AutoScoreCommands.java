...
public class AutoScoreCommands {
  ...
  public static Command runTrackTargetCommand(Turret turret, ShooterHood shooterHood, ShooterFlywheel shooterFlywheel, boolean isLeft) {
    return Commands.run(
        () -> {
        ...
        turret, shooterHood, shooterFlywheel);
  }
}
