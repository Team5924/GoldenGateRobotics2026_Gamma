...
public class ShooterFlywheel extends SubsystemBase {
  ...
  public void periodic() {
    ...
    Logger.recordOutput("ShooterFlywheel/TimeSinceLastStateChange", timeSinceLastStateChange = FieldState.getTime() - lastStateChange);
  ...
  public boolean isAtSetpoint() {
    ...
    return EqualsUtil.epsilonEquals(inputs.setpointVelocity, inputs.shooterFlywheelVelocityRadsPerSec, Constants.GeneralShooterFlywheel.EPSILON_Velocity);
  }
  ...
  public void setGoalState(ShooterFlywheelState goalState) {
    ...
    if (goalState.equals(ShooterFlywheelState.MANUAL) && Math.abs(input) <= 0.05) return; // TODO: REMEMBE RTO COMEMR THITS BACK IN WHEN WWEH PULL IN MAINB RNZCH
