...
import org.team5924.frc2026.util.Bounds;
...
public class LaunchCalculator {
  ...
  public static final LaunchPreset hoodMinPreset =
      new LaunchPreset(
          new LoggedTunableNumber(
              "LaunchCalculator/Presets/HoodMin/HoodAngle", Units.radiansToDegrees(Constants.ShooterHoodLeft.MIN_POSITION_RADS)),
          new LoggedTunableNumber("LaunchCalculator/Presets/HoodMin/FlywheelSpeed", 50));
  public static final LaunchPreset hoodMaxPreset =
      new LaunchPreset(
          new LoggedTunableNumber(
              "LaunchCalculator/Presets/HoodMax/HoodAngle", Units.radiansToDegrees(Constants.ShooterHoodLeft.MIN_POSITION_RADS)),
  ...
  private static final double hubPassLine =
      FieldConstants.LinesHorizontal.rightBumpStart - Constants.trackwidthYMeters / 2.0; // left to right
   ...
   */
  public static Pose2d getStationaryAimedPose(Translation2d robotTranslation, boolean forceBlue, boolean isLeft) {
    // Calculate target
    ...
    return new Pose2d(
        robotTranslation, getDriveAngleWithLauncherOffset(robotTranslation.toPose2d(), target, isLeft));
  }
